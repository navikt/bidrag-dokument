...
data class DocumentProperties(
    ...
    constructor(documentProperties: DocumentProperties, currentDocumentIndex: Int) : this(
    ...
    fun isLastDocument(): Boolean =
        numberOfDocuments != null && currentDocumentIndex != null &&
            numberOfDocuments!! > 1 && numberOfDocuments == (currentDocumentIndex!! + 1)
